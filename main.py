...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        add_student_action.triggered.connect(self.insert_add_student)
    ...
    def insert_add_student(self):
        dialog = InsertAddStudentDialog()
        dialog.exec()
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was created as part of my Python course
        """
...
class InsertAddStudentDialog(QDialog):
    def __init__(self):
        super().__init__()
